...
export function CashierActionBar({
  ...
  return (
    <div className="sticky bottom-3 z-20 rounded-lg border border-[#47392E] bg-[#18130F]/96 p-3 shadow-[0_-12px_40px_rgba(0,0,0,.25)] backdrop-blur">
      ...
      {(canReject || canCancel) ? (
        <div className="mt-3 grid gap-2 md:grid-cols-2">
          {canReject ? (
            <label className="grid gap-1.5 text-xs font-medium text-[#BFB0A2]">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-md border border-[#3B3028] bg-[#211A15] px-3 py-2 text-sm text-[#F6EBDD] outline-none transition placeholder:text-[#756A61] focus:border-[#C68A4A] focus:ring-2 focus:ring-[#C68A4A]/20"
