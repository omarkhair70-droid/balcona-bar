...
export class OrdersController {
  ...
  submitCart(
    ...
    return this.ordersService.submitCart(params.sessionId, body ?? {}, idempotencyKey);
  }

  @Get('branches/:branchId/cashier/orders')
  findCashierOrders(@Param() params: BranchIdParamDto, @Query() query: CashierOrdersQueryDto) {
  ...
  accept(@Param() params: OrderIdParamDto, @Body() body: CashierAcceptOrderDto = {}) {
    return this.ordersService.accept(params.orderId, body ?? {});
  }

  @Post('orders/:orderId/cashier/reject')
  reject(@Param() params: OrderIdParamDto, @Body() body: CashierRejectOrderDto = {}) {
